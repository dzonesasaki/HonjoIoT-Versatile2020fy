...
void setup() {
  ...
  digitalWrite(PIN_LED_STICKC,1);delay(500);digitalWrite(PIN_LED_STICKC,0);delay(500);
  digitalWrite(PIN_LED_STICKC,1);delay(500);digitalWrite(PIN_LED_STICKC,0);delay(500);
  getData();
...
void loop() {
  ...
  digitalWrite(PIN_LED_STICKC,1);delay(1900);digitalWrite(PIN_LED_STICKC,0);delay(100);
}
